...
- MiniApps administrativos precisam marcar os cards do catálogo com `data-required-role="admin"` (veja `catalog.json` e `miniapp-catalogo/index.html`). O shell bloqueia `loadMiniApp` quando o papel atual não atende ao requisito.
