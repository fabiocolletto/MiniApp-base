...
- Sempre que um miniapp for carregado pelo shell, garanta que ele envie `{ action: 'miniapp-header', title: '...', subtitle: '...' }` via `window.parent.postMessage` para manter o cabeçalho sincronizado.
