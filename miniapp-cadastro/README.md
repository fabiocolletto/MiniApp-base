...
- `js/cadastro.js`: script responsável pela tradução das cópias, validação do formulário e comunicação com o shell.
...
## Manutenção
- Sempre que novos campos forem adicionados ao formulário, atualize as traduções em `js/cadastro.js` e ajuste o resumo exibido após o envio.
