...
## Scripts
- `npm install` – instala as dependências do React, Firebase e ferramentas de build.
...
O app depende do Tailwind via CDN para aplicar as classes utilitárias usadas no JSX e mantém toda a lógica original de áudio, autenticação Firebase e navegação entre telas.
