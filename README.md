...
O cabeçalho do painel principal também oferece um botão "Abrir catálogo" que recarrega a listagem imediatamente dentro do iframe ativo, evitando depender apenas do menu do rodapé para retornar ao catálogo padrão.
